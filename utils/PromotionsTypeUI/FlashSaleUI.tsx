...
const FlashSaleUI = ({ promotionProducts }: props) => {
    ...
    return (
        <div
            ...
            className="@container rounded-md p-3 @sm:p-4 @md:p-6 flex flex-col justify-between h-full  text-white relative"
        >
            {/* Header */}
                ...
                <div className="w-full flex flex-col justify-center items-center text-center relative">
                    ...
                    <div className="flex items-center z-30 ">
                        <div className="flex flex-col">
                            ...
                            <Label className="font-orbitron text-[10px] @sm:text-[10px] @2xl:text-[15px] leading-none bg-[#FFD477] @xl:px-1 xl:py-[4px]  @2xl:px-2 @2xl:py-[6px] text-center flex justify-center items-center">
